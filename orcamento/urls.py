...
urlpatterns = [
    ...
    path('ver_tratativa/<int:id_orcamento>/', views.editar_previa, name='ver_orcamento_tratativa'),
    ...
    path('reenio_pedido_gerencia/', views.reenvio_pedido_gerencia, name='reenio_pedido_gerencia'),
