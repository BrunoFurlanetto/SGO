...
function remover_refeicao(celula_pai) {
    const refeicao_data_evento = celula_pai.className
    console.log(refeicao_data_evento)
...
function adicionar_refeicao(celula_pai) {
...
function atualizar_totais(refeicao) {
    ...
    valores.each(function () {
        ...
        // Caso contrário, só conta se não estiver "disabled"
