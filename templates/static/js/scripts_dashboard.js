...
$(document).ready(() => {
    ...
    if ($('.monitoria').length == 0) {
        ...
        $('#fichas_financeiras #negadas, #fichas_financeiras #aprovadas').iniciarlizarDataTableOrcamento([0, 1, 4, 5], 0, [])
        $('#fichas_financeiras #aguardando_proessamento').iniciarlizarDataTableOrcamento([0, 3, 4], 0, [])
