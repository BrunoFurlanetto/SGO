...
class FichaDeAvaliacao(models.Model):
    ...
    instituicao = models.ForeignKey(ClienteColegio, on_delete=models.PROTECT)
    cidade = models.CharField(max_length=255)
    n_alunos = models.IntegerField()
    n_professores = models.IntegerField()
    serie = models.CharField(max_length=255)
    nome_avaliador = models.ForeignKey(Responsavel, on_delete=models.PROTECT)
    cargo_avaliador = models.CharField(max_length=255)
    email_avaliador = models.EmailField()
    nome_vendedor = models.ForeignKey(Vendedor, on_delete=models.SET_NULL, null=True)
