...
class OrdemDeServicoEmpresa(forms.ModelForm):
    class Meta:
        ...
        widgets = {'instituicao': forms.TimeInput(attrs={'onClick': 'verificarObrigatoriedade()'}),
                   ...
                   'saida_2_locacao_2': forms.TimeInput(attrs={'type': 'time'}),
                   'saida_3_locacao_2': forms.TimeInput(attrs={'type': 'time'}),
                   'entrada_1_locacao_3': forms.TimeInput(attrs={'type': 'time'}),
                   'entrada_2_locacao_3': forms.TimeInput(attrs={'type': 'time'}),
                   'entrada_3_locacao_3': forms.TimeInput(attrs={'type': 'time'}),
                   'saida_1_locacao_3': forms.TimeInput(attrs={'type': 'time'}),
                   'saida_2_locacao_3': forms.TimeInput(attrs={'type': 'time'}),
                   'saida_3_locacao_3': forms.TimeInput(attrs={'type': 'time'}),
                   }
